...
export const ONBOARDING_VARIABLES: DemoCallVariable[] = [
  ...
  {
    name: "life_context_at_origin",
    label: "Life context at origin",
    phase: 2,
    meaning: "Step (1) of the 7-step FA — what was going on in the prospect's life around the period when the loop first turned on.",
    inputKind: "textarea",
    cleanable: true,
    frameworkSemantics: "The surrounding life context for the origin moment — what the prospect's life looked like in that period (age, life stage, what they were doing, who they were around). Not the moment itself; the world it sat in. First-person, preserve specifics.",
  },
  {
    name: "prior_assumption_at_origin",
    label: "Prior assumption at origin",
    phase: 2,
    meaning: "Step (2) of the 7-step FA — the rule the prospect was operating by going INTO the moment. Load-bearing: the whole picture synthesis in Phase 4 depends on capturing this directly.",
    inputKind: "textarea",
    cleanable: true,
    frameworkSemantics: "The expectation/assumption the prospect was operating by before the loop turned on. Full sentence, in their voice, ideally in the form 'si X entonces Y', 'Y la gente es Z', or 'cuando hago X, recibo Y'. This is the assumption that got shattered when the moment unfolded — it feeds the shattered_assumptions synthesis in Phase 4.",
  },
  {
    name: "what_came_back_at_origin",
    label: "What came back at origin",
    phase: 2,
    meaning: "Step (4) of the 7-step FA — the factual outcome that broke the prior assumption.",
    inputKind: "textarea",
    cleanable: true,
    frameworkSemantics: "The feedback or outcome the prospect received in the origin moment — the thing that actually happened in response to their action, and that violated their prior_assumption_at_origin. Factual / observational, not emotional. First-person where it fits.",
  },
  {
    name: "feelings_at_origin",
    label: "Feelings at origin",
    phase: 2,
    meaning: "Step (5) of the 7-step FA — the emotion words the prospect felt in the moment.",
    inputKind: "textarea",
    cleanable: true,
    frameworkSemantics: "Emotion words only, verbatim from the prospect — single words or short emotion-phrases (frustración, miedo, impotencia, vergüenza). Not full sentences describing situations. Preserve emotional charge and original language.",
  },
  {
    name: "self_talk_at_origin",
    label: "Self-talk at origin",
    phase: 2,
    meaning: "Step (6) of the 7-step FA — the prospect's inner monologue during and after the moment, the harshest version, verbatim.",
    inputKind: "textarea",
    cleanable: true,
    frameworkSemantics: "The prospect's inner voice during and after the origin moment, in first person, verbatim. The harshest version they gave you, not a polished paraphrase.",
  },
  {
    name: "post_shift_at_origin",
    label: "Post-shift at origin",
    phase: 2,
    meaning: "Step (7) of the 7-step FA — what the prospect started doing or expecting differently after the moment. Either a new harder expectation, or a behavioural-avoidance pattern, or both.",
    inputKind: "textarea",
    cleanable: true,
    frameworkSemantics: "What shifted for the prospect AFTER the origin moment. Either an expectation shift in their voice ('después de eso, empecé a esperar Y'), or a behavioural-avoidance pattern they began running ('simplemente dejé de ponerme en esas situaciones'), or both. Capture what they actually said — don't theorise about the response form.",
  },
  {
    name: "precipitantes",
    label: "Precipitantes",
  ...
  // ---- Phase 4 — Name the loop ----
  {
    ...
    label: "Scary reality",
    phase: 4,
    meaning: "The reality that triggers the loop, in the prospect's wording. Candidate framings offered, prospect picks. The daily face of the shattered assumption — the form the assumption-reminder takes today.",
    inputKind: "textarea",
    cleanable: true,
  ...
  {
    name: "shattered_assumptions",
    label: "Shattered assumptions",
    phase: 4,
    meaning: "The assumption(s) the prospect used to hold that keep getting broken — what {{scary_reality}} is the daily reminder of. Synthesized from {{prior_assumption_at_origin}} via amplification; prospect's correction is the data. One or more sentence-form assumptions in their voice.",
    inputKind: "textarea",
    cleanable: true,
    frameworkSemantics: "One or more sentence-form assumptions the prospect used to hold, in their voice. Examples: 'Si trabajo duro y soy perfecto, voy a ser amado y admirado', 'Si entrego, la gente se queda'. Often a single assumption surfaces in different clothing across the origin moments — capture as one assumption with multiple shattering moments, not as separate entries. Don't theorise about the response form (no 'assimilation', 'over-accommodation', 'stuck point' labels).",
  },
  {
    name: "enemy_name",
    label: "Enemy name",
