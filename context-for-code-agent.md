...
│   │   ├── story-control.tsx     # Ritual Story broadcaster panel (Doc/Cycle/Neuro/Clear)
...
│   │   ├── availability.ts       # pure slot computation (Bogotá-fixed UTC-5)
