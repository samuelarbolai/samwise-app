...
// Extracted from app/page.tsx 2026-06-24 so /for-experts can mount it as
// a view too — therapists sometimes need to register rituals for their
// own users without leaving the for-experts shell. Both the operator
// index (/) and the for-experts copilot route render the SAME component.
...
export function RegisterRitualCard() {
